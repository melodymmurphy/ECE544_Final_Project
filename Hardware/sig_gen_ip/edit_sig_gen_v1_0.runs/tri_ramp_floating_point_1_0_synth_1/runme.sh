...
HD_PWD='C:/Users/jlaw/ece544/sig_gen_ip/edit_sig_gen_v1_0.runs/tri_ramp_floating_point_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tri_ramp_floating_point_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tri_ramp_floating_point_1_0.tcl
