...
bool MIDI_processor_getNoteOn();
uint8_t MIDI_processor_getNote();
uint8_t MIDI_processor_getModulation();
void MIDI_processor_setControl(uint8_t data);
uint8_t MIDI_processor_readControl();
uint8_t MIDI_processor_readInterrupts();
void MIDI_processor_clearDisableInterrupts();
void MIDI_processor_enableInterrupts();
