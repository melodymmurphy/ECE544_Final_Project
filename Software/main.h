...
*
* Header file for the main function
*
******************************************************************************/
...
#define BUFFER_BRAM_DEVICE_ID		XPAR_BRAM_2_DEVICE_ID
#define BUFFER_BRAM_DATA_WIDTH		XPAR_BRAM_2_DATA_WIDTH
#define BUFFER_BRAM_BASEADDR		XPAR_BRAM_2_BASEADDR
#define BUFFER_BRAM_HIGHADDR		XPAR_BRAM_2_HIGHADDR
