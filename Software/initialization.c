...
static XUartNs550Format midi_format;	// configuration struct for MIDI output UART
static XBram_Config* XBRAM0_config;		// configuration struct for audio buffer BRAM
static XBram_Config* XBRAM1_config;		// configuration struct for MIDI note BROM
...
// Turn off OLED screen and SSDs before system shutdown
