...
*
* Header file for MIDI receiver and transmitter implementation
*
******************************************************************************/
...
#define PITCH_A4		69
#define CHANNEL_1		0				// MIDI channel we're transmitting on
#define NOTE_0_MASK		0xFF000000		// mask for first note pressed in note data register of MIDI processor
