...
* @file display.c
*
* OLED display functions included in ECE 544 Project 1
*
******************************************************************************/
...
// swap bytes to write to font color
uint16_t ByteSwap(uint16_t val)
{
	uint16_t swapped_hi, swapped_lo, swapped;
	swapped_hi = (val & 0x00FF) << 8;
	swapped_lo = (val & 0xFF00) >> 8;
	swapped = swapped_hi | swapped_lo;
