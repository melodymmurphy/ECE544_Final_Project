...
*
* Header file for system level functions. Note that this file grew WAY PAST
* its intended size. Many of the implementation functions should be move to
* their respective modules, but the time crunch scattered our organization.
* I'll clean this up for future use.
*
******************************************************************************/
